...
export function SolanaIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 128 128" fill="currentColor">
      <path
        d="M93.94 42.65l-28.5-16.46a13.22 13.22 0 0 0-13.23 0l-28.5 16.46a13.22 13.22 0 0 0-6.61 11.45v32.92a13.22 13.22 0 0 0 6.61 11.45l28.5 16.46a13.22 13.22 0 0 0 13.23 0l28.5-16.46a13.22 13.22 0 0 0 6.61-11.45V54.1a13.22 13.22 0 0 0-6.61-11.45z"
        fill="#14F195"
      />
    </svg>
  );
